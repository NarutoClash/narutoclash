// ✅ LINKS CORRETOS - EXTRAÍDOS DO IMGBB
export const JUTSU_GIFS: Record<string, string> = {
  ...
  // ===== SUITON (ÁGUA) =====
  'Suiton: Daibaku no Jutsu': 'https://i.ibb.co/vCQkmwGF/Suiton-Daibaku-no-Jutsu.gif',
...
// ✅ NOTA: Faltam alguns jutsus que estavam no código original mas não vieram nos links.
// Se você tiver mais GIFs, me envie que eu adiciono aqui.
// 
// Jutsus que estavam no código antigo mas não vieram nos novos links:
// - Doton: Arijigoku
// - Futon: Atsugai
// - Suiton: Daibaku no Jutsu no Jutsu (esse tinha "no Jutsu" duplicado no nome)
